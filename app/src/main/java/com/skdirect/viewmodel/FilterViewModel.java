...
public class FilterViewModel extends ViewModel {
    ...
    public LiveData<ArrayList<NearProductListModel>> getFilterList() {
          nearProductListViewModel=null;
            nearProductListViewModel = new MutableLiveData<>();
        return nearProductListViewModel;
    }

    public MutableLiveData<ArrayList<NearProductListModel>> getFilterListRequest(PaginationModel paginationModel) {
